...
class WebAppTests(unittest.TestCase):
    ...
    def test_root_dev_scripts_start_three_reload_servers_and_track_pids(self) -> None:
        ...
        self.assertIn("schema_version = 4", start_script)
        self.assertIn("requiredStateSchemaVersion = 4", start_script)
        ...
        self.assertIn("schema_version=4", start_bash)
        self.assertIn('required_state_schema_version="4"', start_bash)
        ...
        self.assertIn('"$schema_version" == "4"', stop_bash)
